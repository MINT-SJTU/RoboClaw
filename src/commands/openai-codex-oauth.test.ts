...
const mocks = vi.hoisted(() => ({
  ...
  withTemporaryEnvProxyGlobalDispatcher: vi.fn(),
}));
...
vi.mock("../infra/net/undici-global-dispatcher.js", () => ({
  withTemporaryEnvProxyGlobalDispatcher: mocks.withTemporaryEnvProxyGlobalDispatcher,
}));
...
describe("loginOpenAICodexOAuth", () => {
  beforeEach(() => {
    ...
    mocks.withTemporaryEnvProxyGlobalDispatcher.mockImplementation(
  ...
  it("returns credentials on successful oauth login", async () => {
    ...
    expect(mocks.withTemporaryEnvProxyGlobalDispatcher).toHaveBeenCalledOnce();
